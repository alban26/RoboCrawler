...
class Ex(QMainWindow):
    ...
    def __init__(self):
        ...
        self.ui.param_min_deg_j1_txt.setText("-15")
        self.ui.param_max_deg_j1_txt.setText("35")
        self.ui.param_deg_steps_j1_txt.setText("6")
        self.ui.param_min_deg_j2_txt.setText("35")
        self.ui.param_max_deg_j2_txt.setText("135")
